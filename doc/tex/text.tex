...
The cluster installation will consist of the following steps:
\begin{itemize}
...
Cluster update to a newer version
\begin{itemize}
  \item Update the cluster to a newer version
  \item Update result check
\end{itemize}

Recovery of the Primary node after a crash
\begin{itemize}
...
Vertical scaling of the cluster
\begin{itemize}
...
\n{2}{Crunchy Postgres for Kubernetes (PGO)}
