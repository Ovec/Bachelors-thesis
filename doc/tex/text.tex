...
The static test process was divided into three separate subprocesses, each with its own testing procedures.
...
Additional training needs were identified during the Ease of Use testing, where both CNPGO and PPO required the use of Helm for the deployment of monitoring. During these tests, the CNPGO cluster was easily uninstalled using Kubectl, indicating that the CNPGO plugin isn't necessary for utilizing CNPGO.
...
\tab{Training needed}{tab:operatorTraining}{1}{|l|l|l|l|l|}{
    ...
    2nd training & Kustomize	 & Helm	& Helm & Helm\\ \hline \hline
...
\tab{Documentation examples}{tab:operatorDocExamples}{1}{|l|l|l|l|l|}{
    ...
    Uninstall&	Yes &	Yes &	Yes &	No \\ \hline  \hline
    Documentation examples &	100\%	& 90\%	& 80\%	& 80\% \\ \hline
}


The overall learnability rating of the Operators, as depicted in Table \ref{tab:operatorLearnability}, was calculated as the average of the scores from the required training and the documentation examples. Given the high level of overall learnability among the operators, it can be derived that these operators should be relatively easy to learn.
