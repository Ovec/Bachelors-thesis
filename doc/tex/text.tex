...
\tab{Test plan No 1}{tab:testplan1}{1}{|l|l|}{
  ...
  Revision & 1 \\ \hline
  Introducton &  \makecell{Documentation walkthrough} \\ \hline
  Test items & Operator documentation \\ \hline
  Criteria to be covered & C1 \\ \hline
  Test type &	Static \\ \hline
  Test approach &	Documentation walkthrough \\ \hline
  Exit criteria & All documentation reviewed  \\ \hline
  Delivarables & List of features \\ \hline
  Duration & 1 h for each Operator \\ \hline
  Reviewer & Miroslav Šiřina \\ \hline
  Start & April 17th \\ \hline
  Schedule & \makecell{April 17th documentations walkthrough. \\ April 18th summary and test report.} \\ \hline
}
