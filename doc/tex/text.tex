...
\begin{itemize}
  \item Context of testing:
        \begin{itemize}
          ...
          \item Test basis: Defined requirements.
        \end{itemize}
  \item Risk register:
        \begin{itemize}
  ...
  \item	Test strategy:
        \begin{itemize}
          ...
          \item Test design techniques: Checklists and Use cases.
          \item Entry criteria: Static testing – test plan, checklists, Dynamic – test plan, use cases, prepared environment, created testing model.
          \item Exit criteria – decision metrics were collected.
          \item Test competition criteria: All requirements covered by at least one test.
          ...
          \item Metrics to be collected:
                \begin{itemize}
                  \item Static testing: Vulnerability analysis (number of vulnerabilities and their severity), Checklist Documentation review (contents of documentation), Checklist Documentation review (Operator capabilities), Repository review (sum of issues, sum of repaired issues, sum of Operator users, sum of contributors, sum of users, sum of stars),
          ...
          \item Testing activities and estimates:
                \begin{itemize}
                  \item Enviroment setup – 30m.
                  \item Documentation checklist for Capabilities – 2h.
                  \item Documentation checklist for Contents – 2h.
                  \item Repository metrics gathering – 2h.
                  \item Use cases – 8h.
                  \item Static testing for Capabilities – 4h/Operator.
                  \item Static testing for Contents – 1h/Operator.
                  \item Vulnerability analysis – 1h/Operator.
                  \item Dynamic test proces – 24h/Operator.
                  \item Test competiton report – 1h/testing day.
                \end{itemize}
          ...
          \item Schedule
                \begin{itemize}
                  \item April 16th Test management and analyst training.
                  \item April 17th Documentations checklists should be created.
                  \item April 18th Repository metrics gathering, static testing for capabilities PGO.
                  \item April 19th Static testing for capabilities CNPGO, SPGO.
                  \item April 20th Static testing for capabilities PPO, Static testing for Contents PPO.
                  \item April 21th Static testing for Contents PGO, SPGO, CNPGO, Static vulnerability analysis for all Operators. Requirements retrospective.
                  \item April 22th KUTLL training, test analyst training.
                  \item April 24th Use cases preparation.
                  \item April 25th – 27th Dynamic testing PGO.
                  \item April 28th – May 1st Dynamic testing CNPGO.
                  \item May 2nd – 4th  Dynamic testing SPO.
                  \item May 6th – 8th  Dynamic testing PPO.
                  \item May 9th Testing closure.
                \end{itemize}
        \end{itemize}
\end{itemize}
