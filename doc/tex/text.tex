...
This chapter presents a high-level overview of the testing methodology, which will be used to compare selected Postgres Operators for lifecycle management. The goal of the methodology is to deliver a test process that produces test reports forming the basis of this comparison.
...
\n{2}{Documents}
All documents must meet the requirements of ISO/IEC/IEE 29119-3\footnote[1]{https://standards.ieee.org/ieee/29119-3/5310/}

\n{2}{Level of detail}
Please note that this chapter provides only a high-level overview of the testing methodology. More detailed information can be found in ISO/IEC/IEEE 29119-2\footnote[2]{https://standards.ieee.org/ieee/29119-2/7498/}. If there are any doubts regarding the testing process, this standard should be used as a guide to ensure that all necessary aspects of testing are properly addressed.
