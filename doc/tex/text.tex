...
Reliability and maintenance testing consists of two parts: renewal and maturity. Both of these parts form part of the first static testing process because they share the same test items. This process was designed to provide the necessary information for decision-making regarding the maintenance quality and maturity level of the Operators. A detailed test plan and further specifics of this process can be found in Appendix A II.

Results of these repositories analysis are depicted in Table \ref{tab:operatorTestRelAndMaint}.
