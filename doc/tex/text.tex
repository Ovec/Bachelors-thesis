...
Each operator was then tested according to this procedure, with the overal vulnerability results presented in Table \ref{tab:operatorTestVulnTrivy}.
...
Even complex tasks, such as performing a major version upgrade, can be easily carried out via this user interface.
