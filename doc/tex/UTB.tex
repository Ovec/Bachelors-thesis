...
\usepackage{enumitem}   % Pro requirements
\usepackage{makecell}
\usepackage{listings}
...
\newcommand{\zadani}{
	...
	\includegraphics[width=160mm]{graphics/zadani_p1.png}
...
\setlist[requirements]{label=RQ\arabic*:}

% Criteria seznam
\newlist{criterias}{enumerate}{1}
\setlist[criterias]{label=C\arabic*:}
...
\newcommand{\prohlaseni}{{
			...
			\ifenglish
				...
				Ve Zlíně, dne 25. 5. 2023 \hspace{5.0cm} Miroslav Šiřina, v. r.
