...
\nastavklicovaslovacz{postgres, kubernetes, operátor, životní cyklus, databáze, docker, automatizace}
\nastavklicovaslovaen{postgres, kubernetes, operator, lifecycle, database, docker, automation}
